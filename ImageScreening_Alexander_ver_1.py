...
############################################
if(use=="CH") : 
    images_root_path = "/home/alexanderandersen/2_wave/1_skvulp/images/CH" #pointing path where images are stored (both XRay and MR)
elif use=="CZ" : 
    images_root_path = "/home/alexanderandersen/2_wave/CZ/CZ/" #pointing path where images are stored (both XRay and MR)
...
if(use=="CH") : 
    excel_metadata_CH = pd.read_csv("/home/alexanderandersen/2_wave/1_skvulp/metadata/CH/xray_mri_metadata_second_wave_Exer_20220324.csv", sep=",") #load excel file
    ...
    img_metadata_image_date_list = np.unique(excel_metadata_CH.image_date) #generate a list of image dates that exist in the metadata excel file
    ...
    excel_metadata_CZ = pd.read_excel("/home/alexanderandersen/2_wave/metadata/CZ/Template_image_metadata_eurospa_imaging_second_wave_part2_akba.xlsx") #load excel file
    ...
    for x in excel_metadata_CZ.image_date:
        if str(x) not in img_metadata_image_date_list:
            img_metadata_image_date_list.append(str(x))
